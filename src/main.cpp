...
<head>
  ...
  <style>
    ...
    .desired-row input[type="number"]::-webkit-outer-spin-button { -webkit-appearance: none; appearance: none; height: 0.9em; width: 1.4em; margin: 0; opacity: 1; cursor: pointer; background-color: #2a3a5e; background-repeat: no-repeat; background-position: center; background-size: 0.5em 0.4em; border-left: 1px solid #3a4a6e; }
    .desired-row input[type="number"]::-webkit-outer-spin-button { background-image: url('data:image/svg+xml,<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 12 8\"><path fill=\"%23a0aec0\" d=\"M6 2L2 6h8z\"/></svg>'); border-radius: 0 4px 0 0; }
    .desired-row input[type="number"]::-webkit-inner-spin-button { background-image: url('data:image/svg+xml,<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 12 8\"><path fill=\"%23a0aec0\" d=\"M6 6L2 2h8z\"/></svg>'); border-radius: 0 0 4px 0; margin-top: 1px; }
    .desired-row input[type="number"]::-webkit-outer-spin-button:hover { background-color: #3a4a6e; background-image: url('data:image/svg+xml,<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 12 8\"><path fill=\"%23e94560\" d=\"M6 2L2 6h8z\"/></svg>'); border-left-color: #e94560; }
    .desired-row input[type="number"]::-webkit-inner-spin-button:hover { background-color: #3a4a6e; background-image: url('data:image/svg+xml,<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 12 8\"><path fill=\"%23e94560\" d=\"M6 6L2 2h8z\"/></svg>'); border-left-color: #e94560; }
